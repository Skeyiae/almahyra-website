...
export default function PropertyInteractiveContent({
    ...
    const specs = selectedUnit ? [
        { label: "Kamar Tidur", value: selectedUnit.bedrooms ? `${selectedUnit.bedrooms} Unit` : null, icon: "bed" },
        { label: "Kamar Mandi", value: selectedUnit.bathrooms ? `${selectedUnit.bathrooms} Unit` : null, icon: "bath" },
        { label: "Listrik", value: selectedUnit.electricity || null, icon: "power" },
        { label: "Sumber Air", value: selectedUnit.waterSource || null, icon: "water" },
        { label: "Luas Bangunan", value: selectedUnit.buildingArea ? `${selectedUnit.buildingArea} m²` : null, icon: "home" },
        { label: "Luas Tanah", value: selectedUnit.landArea ? `${selectedUnit.landArea} m²` : null, icon: "layout" },
